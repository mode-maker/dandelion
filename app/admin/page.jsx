  ...
  return (
    <main className="min-h-screen px-4 md:px-8 py-6 bg-[#0e1712] text-[#E7E8E0]">
      ...
      >
              ...
              <div className="flex flex-col items-end gap-2">
                <label className="inline-flex items-center gap-2 text-sm">
                  <input
                    ...
                    onChange={(e) =>
                      updateMeta(p.id, { published: e.target.checked })
                    }
                  />
                  Опубликовано
                </label>
        ...
        {/* Нижний «пэддинг» виртуализации */}
        <div
          style={{
            height: Math.max(0, (ITEM_H + GAP) * (items.length - range.end)),
          }}
        />
